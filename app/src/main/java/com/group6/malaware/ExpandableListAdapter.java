...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    //private TextView tView_genNum;
    //private TextView tView_genRate;
    //private TextView tView_genCost;

    private ArrayList<TextView> tView_genNum = new ArrayList<TextView>(6);
    private ArrayList<TextView> tView_genRate = new ArrayList<TextView>(6);
    private ArrayList<TextView> tView_genCost = new ArrayList<TextView>(6);

    private ArrayList<Button> btn_timesOne = new ArrayList<Button>(6);
    private ArrayList<Button> btn_timesTen = new ArrayList<Button>(6);
    private ArrayList<Button> btn_timesTwoFive = new ArrayList<Button>(6);
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null) {
            ...
            Log.i("Info", "Inflating Group Position: " + groupPosition);
            ...
            tmpButton_x1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Log.i("Info", "Adding to Group Position: " + groupPosition);
                }
            });
